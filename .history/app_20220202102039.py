                ...
                children=[
                    ...
                    html.Button(
                        ...
                        children=dcc.Link(html.H5(
                                    "Napolitano et al. 2021", style={"margin-top": "0px"}
                                ), href= 'https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2021SW002925', target='_blank'),
                        n_clicks=0,
                        style={
                            # 'borderColor': 'black',
                            'color': 'black',
...
app.layout = dbc.Container([
    html.Div([
        ...
        # dbc.Container(
        #     [
            html.Div([dbc.Button("Instructions", id="button_mo"),
                dbc.Modal(
                    [
                        dbc.ModalHeader(dbc.ModalTitle("Readme!"), close_button=True),
                        dbc.ModalBody(dcc.Markdown(text_markdown), style={"width": "50%"}),
...
@app.callback(
        ...
        [Input("button_mo", "n_clicks"), Input("close-centered", "n_clicks")],
        [State("modal", "is_open")],
    )
